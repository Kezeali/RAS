...
namespace Rocket { namespace AngelScript { 
	int AddElementsScriptSection(asIScriptEngine *engine, const char *module_name)
	{
		const char * script =
			...
			"e_String GetTagName() const { return __inner.GetTagName(); }\n"
			"e_String GetId() const { return __inner.GetId(); }\n"
			...
			"void AddEventListener(const e_String&in p1, IEventListener@ p2, bool p3) { __inner.AddEventListener(p1, p2, p3); }\n"
			"void AddEventListener(const e_String&in p1, IEventListener@ p2) { __inner.AddEventListener(p1, p2); }\n"
			"void AddEventListener(const e_String&in p1, const e_String&in p2, bool p3) { __inner.AddEventListener(p1, p2, p3); }\n"
