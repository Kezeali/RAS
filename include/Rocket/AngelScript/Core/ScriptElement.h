...
namespace Rocket { namespace AngelScript { 
	int AddElementsScriptSection(asIScriptEngine *engine, const char *module_name)
	{
		const char* script =
			...
			"bool SetProperty(const String&in p1, const String&in p2) { return __inner.SetProperty(p1, p2); }\n"
			"void RemoveProperty(const String&in p1) { __inner.RemoveProperty(p1); }\n"
			"String GetProperty(const String&in p1) { return __inner.GetProperty(p1); }\n"
			"float ResolveProperty(const String&in p1, float p2) { return __inner.ResolveProperty(p1, p2); }\n"
			"String GetTagName() const { return __inner.GetTagName(); }\n"
			"String GetId() const { return __inner.GetId(); }\n"
			"void SetId(const String&in p1) { __inner.SetId(p1); }\n"
			...
			"void GetInnerRML(String&out p1) { __inner.GetInnerRML(p1); }\n"
			"void SetInnerRML(const String&in p1) { __inner.SetInnerRML(p1); }\n"
			"bool Focus() { return __inner.Focus(); }\n"
			"void Blur() { __inner.Blur(); }\n"
			"void Click() { __inner.Click(); }\n"
			"void AddEventListener(const String&in p1, IEventListener@ p2, bool p3) { __inner.AddEventListener(p1, p2, p3); }\n"
			"void AddEventListener(const String&in p1, IEventListener@ p2) { __inner.AddEventListener(p1, p2); }\n"
			"void AddEventListener(const String&in p1, const String&in p2, bool p3) { __inner.AddEventListener(p1, p2, p3); }\n"
			"void AddEventListener(const String&in p1, const String&in p2) { __inner.AddEventListener(p1, p2); }\n"
			"bool DispatchEvent(const String&in p1, const e_Dictionary&in p2, bool p3) { return __inner.DispatchEvent(p1, p2, p3); }\n"
			"bool DispatchEvent(const String&in p1, const e_Dictionary&in p2) { return __inner.DispatchEvent(p1, p2); }\n"
			"bool DispatchEvent(const String&in p1) { return __inner.DispatchEvent(p1); }\n"
			...
			"Element@ GetElementById(const String&in p1) { return __inner.GetElementById(p1); }\n"
			"void GetElementsByTagName(ElementList&out p1, const String&in p2) { __inner.GetElementsByTagName(p1, p2); }\n"
			"}\n";
		...
		module->SetDefaultNamespace("Rocket");
