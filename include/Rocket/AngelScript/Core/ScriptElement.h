...
namespace Rocket { namespace AngelScript { 
	int AddElementsScriptSection(asIScriptEngine *engine, const char *module_name)
	{
		const char* script =
			...
			"bool DispatchEvent(const String&in p1, const Dictionary&in p2, bool p3) { return __inner.DispatchEvent(p1, p2, p3); }\n"
			"bool DispatchEvent(const String&in p1, const Dictionary&in p2) { return __inner.DispatchEvent(p1, p2); }\n"
