...
namespace Rocket { namespace AngelScript { 
	int AddElementsScriptSection(asIScriptEngine *engine, const char *module_name)
	{
		const char * script =
			...
			"const e_String@ GetProperty(const e_String&in p1) { return __inner.GetProperty(p1); }\n"
			"float ResolveProperty(const e_String&in p1, float p2) { return __inner.ResolveProperty(p1, p2); }\n"
			"const e_String@ GetTagName() const { return __inner.GetTagName(); }\n"
			"const e_String@ GetId() const { return __inner.GetId(); }\n"
			...
			"void AddEventListener(const e_String&in p1, IEventListener@ p2) { __inner.AddEventListener(p1, p2); }\n"
			"void RemoveEventListener(const e_String&in p1, IEventListener@ p2) { __inner.RemoveEventListener(p1, p2); }\n"
			"void AddEventListener(const e_String&in p1, const e_String&in p2) { __inner.AddEventListener(p1, p2); }\n"
			"void RemoveEventListener(const e_String&in p1, const e_String&in p2) { __inner.RemoveEventListener(p1, p2); }\n"
			"bool DispatchEvent(const e_String&in p1, const e_Dictionary&in p2, bool p3) { return __inner.DispatchEvent(p1, p2, p3); }\n"
			"bool DispatchEvent(const e_String&in p1, const e_Dictionary&in p2) { return __inner.DispatchEvent(p1, p2); }\n"
			"bool DispatchEvent(const e_String&in p1) { return __inner.DispatchEvent(p1); }\n"
